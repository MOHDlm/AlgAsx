...
const CAMPAIGN_ABI = [
  "function getInvestorInfo(address _investor) view returns (uint256 contribution, uint256 tokens, bool claimed, bool canClaim)",
...
export default function PortfolioPage() {
    ...
    try {
      ...
      for (let i = 0; i < campaigns.length; i++) {
        ...
        try {
          ...
          const investorInfo = await campaignContract.getInvestorInfo(userAddr);
          const contributionWei = investorInfo.contribution;
  ...
  // ✅ useEffect بعد fetchAllocations
  useEffect(() => {
    fetchAllocations();
  }, []);
