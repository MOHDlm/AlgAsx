...
export default function HomePage() {
  ...
  // الحصول على آخر 3 مشاريع فقط
  const featuredProperties = properties.slice(-3).reverse();
  ...
  return (
    <div className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                For the first time in Algeria, investors can access the real
                estate market through fully-compliant, fractional, tokenized
                ownership powered by blockchain technology
              </p>
              <p className="text-xl text-gray-700 leading-relaxed mb-8">
                Invest in the future of real estate — smarter, safer, and
                simpler.
              </p>
          ...
          >
            ...
            <p className="text-lg text-blue-100 max-w-3xl mx-auto leading-relaxed">
              <span className="font-bold text-orange-400">
                The AlgAsx RMM collateralization platform
              </span>{" "}
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Browse our portfolio of income-generating properties in the
                United States and pick what suits you
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Invest as much as you want - you can start with less than one
                dollar
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Receive your share of rental income daily directly to your
                wallet
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                description:
                  "No need for large capital - invest any amount you want",
              },
              {
                icon: TrendingUp,
                title: "Daily Income",
              ...
              },
              {
                ...
                description:
                  "All smart contracts are audited and secured on the blockchain",
              },
              {
                icon: Zap,
              ...
              },
              {
                ...
                description:
                  "Track everything on the blockchain with complete transparency",
              },
            ].map((benefit, index) => (
              <motion.div
                key={index}
      ...
      {/* Featured Properties - من البلوكشين */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {featuredProperties.map((property) => (
                <motion.a
                  key={property.id}
                  href={`/campaign/${property.contract}`}
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-blue-600 to-blue-800">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <a href="/properties">
            <Button
              size="lg"
              className="bg-orange-500 hover:bg-orange-600 text-white px-10 py-6 text-lg rounded-lg shadow-xl"
            >
              Explore Properties
